...
#define PBsArrIntPend	   P2IFG  //flag of how made the interrupt
#define PBsArrIntEn	       P2IE   // Interrupt Enable Register
#define PBsArrIntEdgeSel   P2IES
#define PBsArrPortSel      P2SEL
#define PBsArrPortDir      P2DIR
#define PB0                BIT0 //usually BIT4
#define PB1                BIT3 // P1.3
...
#define ADC_input_channel0       INCH_0      // A0 P1.0
#define ADC_input_channel3       INCH_3      // A0 P1.3

#define ADC_sample_hold         ADC10SHT_3  // [0 -4 cycles 1 -8 cycles 2 -16 cycles 3 -64 cycles]
...
//#define RADAR_MAX_PAYLOAD_LEN 25
#define MSG_MAX_PAYLOAD   25
#define MSG_BUF_SIZE (2 + MSG_MAX_PAYLOAD + 1)  /* cmd + len + payload + crc */

#define data_BUF_SIZE 32
#define LDR_CALIB_COUNT 11
